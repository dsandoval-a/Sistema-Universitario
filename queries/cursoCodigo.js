document.addEventListener("DOMContentLoaded", () => {
    document
      ...
      .addEventListener("submit", async function (event) {
        ...
        const url = `http://localhost:3000/curso/codigo/${encodeURIComponent(
          userInput
        )}`;
        ...
        try {
          ...
          if(cursoData.length === 0) {
            errorLabel.textContent = "No se encontro ningún curso con el código indicado"
          } else {
